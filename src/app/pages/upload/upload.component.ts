...
import { ciudades, departamentos, departamentos_provinciales, destinos, divisiones, escalafon, escalaJerarquica, estados_civil, grados, municipios, nivelEducativo, provincias, secciones_guardia, sectores, sexos, situacion } from 'src/app/common/data-mockeada';
...
export class UploadComponent implements OnInit {
  ...
  ) 
  {
    ...
    this.forma = this.fb.group({
       ...
       destino_id: [,[Validators.required, Validators.pattern(/^[0-9]*$/)]],
       departamento_id: [,[Validators.required, Validators.pattern(/^[0-9]*$/)]],
       division_id: [,[Validators.required, Validators.pattern(/^[0-9]*$/)]],
       sector_id: [,[Validators.required, Validators.pattern(/^[0-9]*$/)]],
    ...
    this.cargarSeccionesGuardia(parseInt(this.forma.get('departamento_id')?.value));
